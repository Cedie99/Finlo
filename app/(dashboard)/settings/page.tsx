      ...
      <div className="space-y-4 max-w-2xl">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-8 h-8 bg-[#edf5f2] rounded-2xl flex items-center justify-center">
              <User size={16} className="text-[#2f7f76]" />
            </div>
            <h2 className="font-bold text-gray-900">Profile</h2>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-[#2f7f76] to-[#45a79d] flex items-center justify-center text-white font-bold text-lg shadow-sm shadow-[#d1e3df]">
              {initials}
            </div>
            <div>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-8 h-8 bg-[#edf5f2] rounded-2xl flex items-center justify-center">
              <ShieldCheck size={16} className="text-[#2f7f76]" />
            </div>
            <div>
          ...
          <div className="mt-5 flex justify-end">
            <Button
              ...
              className="rounded-full bg-[#2f7f76] hover:bg-[#266a63]"
            >
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-[#edf5f2] rounded-2xl flex items-center justify-center">
                <BookTemplate size={16} className="text-[#216f67]" />
              </div>
              <div>
            ...
            <div className="space-y-2">
              {templates.map((t) => (
                <div key={t.id} className="flex items-center justify-between py-3 px-3 rounded-2xl hover:bg-gray-50 group transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-xl bg-[#edf5f2] flex items-center justify-center">
                      <BookTemplate size={13} className="text-[#2f7f76]" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-sm font-bold text-[#216f67]">{formatCurrency(t.amount)}</span>
                    <button
      ...
      <Dialog open={incomeDialog} onOpenChange={setIncomeDialog}>
        <DialogContent className="rounded-3xl">
          ...
          <div className="space-y-4">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        income.source === t.source && income.amount === t.amount
                          ? "bg-[#2f7f76] text-white border-[#2f7f76]"
                          : "bg-[#edf5f2] text-[#216f67] border-[#d1e3df] hover:bg-[#e3f0ed]"
                      )}
                    >
            ...
            <Button onClick={() => addIncome.mutate(income)} className="w-full rounded-full bg-[#2f7f76] hover:bg-[#266a63] h-11" disabled={addIncome.isPending || !income.source || !income.amount}>
